...
To install the bot, please follow these steps:
...
5. Configure your bot by editing the `config.json` file with your bot's token and other necessary information.
